  ...
  const submitHandler = async (event) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        postRequest({url:"https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyD9IHVJXmO199ELEojC5tmtnsW91qJmN8g",body:authObj,header:{ "Content-Type": "application/json" }},resData)
      } else {
        if (
          ...
          postRequest({url:"https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyD9IHVJXmO199ELEojC5tmtnsW91qJmN8g",body:authObj,header:{ "Content-Type": "application/json" }},resData)
        }
      }
    } catch (err) {
